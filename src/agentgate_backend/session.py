...
Responsibilities:
  - Persist/load state to ~/.agentgate/backends/<name>/state.json.
...
class SessionManager:
    ...
    Note: Telegram-specific fields (thread_bindings, group_chat_ids) have been
    removed. The gateway layer handles channel→backend routing.
    """
    ...
    async def load_session_map(self) -> None:
        ...
        Keys in session_map are formatted as "tmux_session:window_id" (e.g. "agentgate:@12").
